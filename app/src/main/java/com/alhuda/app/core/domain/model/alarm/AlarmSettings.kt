...
data class AlarmSettings(
    ...
    val fajrSound: PrayerAlarmSettings = PrayerAlarmSettings.Bool(true),
    val fajrNotify: PrayerAlarmSettings = PrayerAlarmSettings.Bool(true),
    ...
    val dhuhrSound: PrayerAlarmSettings = PrayerAlarmSettings.Bool(true),
    val dhuhrNotify: PrayerAlarmSettings = PrayerAlarmSettings.Bool(true),
    val asrSound: PrayerAlarmSettings = PrayerAlarmSettings.Bool(true),
    val asrNotify: PrayerAlarmSettings = PrayerAlarmSettings.Bool(true),
    ...
    val maghribSound: PrayerAlarmSettings = PrayerAlarmSettings.Bool(true),
    val maghribNotify: PrayerAlarmSettings = PrayerAlarmSettings.Bool(true),
    val ishaSound: PrayerAlarmSettings = PrayerAlarmSettings.Bool(true),
    val ishaNotify: PrayerAlarmSettings = PrayerAlarmSettings.Bool(true),
